...
INSERT OR IGNORE INTO system_settings (category, key, value, value_type, description, is_sensitive, is_editable) VALUES
  ('ORGANIZATION', 'organization_name', 'Lancaster University Ghana', 'STRING', 'Organization name shown across the application.', 0, 1),
  ...
  ('ORGANIZATION', 'system_name', 'LUG IT Inventory System', 'STRING', 'Display name shown in the application header and reports.', 0, 1),
  ('ORGANIZATION', 'country', 'Ghana', 'STRING', 'Country of operation.', 0, 1),
  ('ORGANIZATION', 'currency', 'GHS', 'STRING', 'Fixed system currency (Ghanaian Cedi). Not user-changeable.', 0, 0),
  ('ORGANIZATION', 'currency_symbol', 'GH₵', 'STRING', 'Fixed currency symbol (Ghanaian Cedi). Not user-changeable.', 0, 0),
  ('ORGANIZATION', 'timezone', 'Africa/Accra', 'STRING', 'Timezone used for displaying dates and times.', 0, 1),
  ...
  ('INVENTORY', 'asset_tag_prefix', 'LUG', 'STRING', 'Prefix applied to newly generated asset tags.', 0, 1),
  ...
  ('REPORTS', 'report_organization_name', 'Lancaster University Ghana', 'STRING', 'Organization name shown on report headers.', 0, 1),
