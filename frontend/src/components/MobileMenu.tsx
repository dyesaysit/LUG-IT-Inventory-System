...
export function MobileMenu({ open, onClose }: MobileMenuProps) {
  ...
  return (
    <>
      ...
      {/* Slide-out panel */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-lug-charcoal transform transition-transform duration-200 lg:hidden ${
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3.5 border-b border-white/10">
          ...
          <button
            type="button"
            onClick={onClose}
            className="text-gray-400 hover:text-white p-1 rounded focus:outline-none focus:ring-2 focus:ring-white/20"
